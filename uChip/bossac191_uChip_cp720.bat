...
REM eof
||||||| parent of 62d55cf (bossac191_uChip_cp720.bat : minor tweaks to comments)
REM bossac_uChip_cp720 -- mew@mew.cx 2022-03-10
REM Flash CircuitPython 7.2.0 to Itaca uChip with BOSSAC 1.9.1
@echo off
REM https://downloads.circuitpython.org/bin/uchip/en_US/adafruit-circuitpython-uchip-en_US-7.2.0.bin
...
REM eof
>>>>>>> 62d55cf (bossac191_uChip_cp720.bat : minor tweaks to comments)
||||||| parent of a01577c (bossac191_uChip_cp720.bat : minor tweaks to comments)
REM bossac_uChip_cp720 -- mew@mew.cx 2022-03-10
REM Flash CircuitPython 7.2.0 to Itaca uChip with BOSSAC 1.9.1
@echo off
REM https://github.com/shumatech/BOSSA/releases/tag/1.9.1
...
REM eof
>>>>>>> a01577c (bossac191_uChip_cp720.bat : minor tweaks to comments)
